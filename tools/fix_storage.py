"""
Automatically updates config/storage.py to the latest directory/file
naming convention and runs pytest.
"""
...
STORAGE_FILE = PROJECT_ROOT / "config" / "storage.py"
...
def main():
    STORAGE_FILE.write_text(NEW_CONTENT, encoding="utf-8")
    print("[OK] Updated config/storage.py")
